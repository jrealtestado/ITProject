...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class=""><a href="{{ url('/assistant/patient') }}">Patient</a></li>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box box-info">
                        ...
                        {!! Form::open(['action' => ['Assistant\\PatientsController@update', $patient->patID], 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <a href="{{ url('/assistant/patient')}}" class="btn btn-default">Cancel</a>
