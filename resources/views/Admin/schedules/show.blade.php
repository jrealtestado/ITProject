                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <a href="{{ url('/admin/schedules') }}" title="Back"><button class="btn btn-warning btn-sm pull-left"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                            <form method="POST" action="{{ url('admin/schedules' . '/' . $schedule->schedID) }}" accept-charset="UTF-8" style="display:inline">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
